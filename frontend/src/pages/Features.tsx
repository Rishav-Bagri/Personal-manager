...
export function Features(){
    return <div className="mt-10" >
        ...
        <div className="p-10 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
            ...
            <FeatureCard title="expense tracker" details="calculate ur expenses"  to="/expense-tracker"></FeatureCard>
            ...
            <FeatureCard title="tasks" details="stores ur task for The day"  to="/taks"></FeatureCard>
        </div>
    </div>
}